...
(function (factory) {
    ...
    var defaults = {
        ...
        displayMinutes: true,      // display minutes
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                data.displayMinutes = !!(data.displayMinutes || data.displayMinutes);
                ...
                thtml = (data.displayCaptions
                    ? (data.displayHours
                        ...
                        + (data.displayMinutes
                            ? '<figure style="max-width:' + maxWidth + 'px">$1<figcaption' + fsStyle + '>'
                                + language.min + '</figcaption></figure>' + dot2
                            : '')
                        + '<figure style="max-width:' + maxWidth + 'px">$1<figcaption' + fsStyle + '>' + language.sec
                        + '</figcaption></figure>'
                    : (data.displayHours ? '$1' + dot2 : '') + (data.displayMinutes ? '$1' + dot2 : '') + '$1'
    ...
    function tick(digit) {
        ...
        if ($.support.transition) {
            ...
            setTimeout(function () {
                ...
                if (data.sec === 0) {
                    $digits.parent().addClass('time-stop');
